package com.marketingeventsbranding.base;
...
public class Base
{
	...
	public Base()
	{
		try {
			prop=new Properties();
			FileInputStream ip=new FileInputStream("C:\\Users\\funak\\AutomationTester\\MarketingEventsBranding\\config.properties");
			prop.load(ip);
		}
		catch (Exception e) {
			e.printStackTrace();
