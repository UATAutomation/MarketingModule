package com.marketingmarketingcalling.base;
...
public class Base
{
	...
	public Base()
	{
		try {
			prop=new Properties();
			FileInputStream ip=new FileInputStream("C:\\Users\\funak\\AutomationTester\\MarketingMarketingCalling\\config.properties");
			prop.load(ip);
		}
		catch (Exception e) {
			e.printStackTrace();
