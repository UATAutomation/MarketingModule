package com.marketingmarketingcalling.utility;
...
public class UtilityFile
{
	...
	public static void screenShot(WebDriver driver) 
	{
		...
		try {
			FileUtils.copyFile(src, new File("C:\\Users\\funak\\AutomationTester\\MarketingMarketingCalling\\ScreenShots\\"+d+".png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
